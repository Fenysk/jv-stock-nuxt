...
<template>
    <article
        class="flex w-48 h-64 overflow-hidden bg-orange-100 border border-orange-200 shadow-sm rounded-xl"
    >
        ...
        <div class="flex flex-col justify-between w-3/4 gap-2 p-2">
            ...
            <div class="flex flex-row items-end justify-between gap-1">
                ...
                <div id="controls" class="flex flex-row justify-end gap-1">
                    ...
                    >
                        Voir le jeu</NuxtLink
                    >
                </div>
            </div>
        </div> -->

        <NuxtLink :to="`/dashboard/games/${game.id}`" class="w-full h-full">
            <img
                :src="`${game.image_url}`"
                alt="Game image"
